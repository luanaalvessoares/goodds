...
function DropshippingGlobal() {
    ...
    return (
        <div>
            <ImageBackground isVideo={false} title="Loja de Dropshipping Global" description="Somos a Primeira Agência de Dropshipping Nacional e Internacional" image={ImageBg}/>
