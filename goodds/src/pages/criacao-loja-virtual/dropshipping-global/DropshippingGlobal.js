...
function DropshippingGlobal() {
    ...
    return (
        <div id="pageLoja">
            ...
            {/* <ImageBackground isVideo={false} title="Loja de Dropshipping Global" description="Somos a Primeira Agência de Dropshipping Nacional e Internacional do Brasil" image={ImageBg}/> */}
