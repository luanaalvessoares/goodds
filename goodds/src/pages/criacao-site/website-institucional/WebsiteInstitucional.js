...
import './WebsiteInstitucional.css';
...
function WebsiteInstitucional() {
    const whatsapp = "https://api.whatsapp.com/send?phone=5511943600303&text=Ol%C3%A1,%20gostaria%20de%20falar%20com%20um%20especialista%20em%20Website%20Institucional";
    ...
    return (
        <div id="websiteInstitucional">
            ...
            <CardsInfoTitle title="Mostre ao mundo sua marca e ofereça a melhor experiência de compra" className="cardsInfoTitle" />
...
export default WebsiteInstitucional;